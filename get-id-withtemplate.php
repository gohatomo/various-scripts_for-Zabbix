...
<?php
///////////////////////////////////////////////////////////////////////////////////
//	Name: get-id-withtemplate.php
//	Description: Get ID for template, item and trigger in JSON format.
///////////////////////////////////////////////////////////////////////////////////
...
$log_file = rtrim($log_dir, '/') . "/get-id-withtemplate_{$date}.log";
if (!file_exists($log_dir)) {
	mkdir($log_dir, 0755);
}

//Datafile get
$data_dir = rtrim($data_dir, '/') . "/get-id-withtemplate";
...
$temp_dir = rtrim($output_dir, '/') . "/get-id-withtemplate_{$date}_{$time}";
...
foreach ($export_array as $key => $value) {
	...
	$output_file = $temp_dir . "/" . "get-id-withtemplate_{$output_host}_{$date}_{$time}.json";
...
if (isset($output_array[0])) {
	$z_file = "{$output_dir}/get-id-withtemplate_{$date}_{$time}.zip";
