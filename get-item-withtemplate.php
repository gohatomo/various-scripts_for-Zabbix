...
<?php
///////////////////////////////////////////////////////////////////////////////////
//	Name: get-item-withtemplate.php
//	Description: Get item for template in JSON format.
///////////////////////////////////////////////////////////////////////////////////
...
$log_file = rtrim($log_dir, '/') . "/get-item-withtemplate_{$date}.log";
if (!file_exists($log_dir)) {
	mkdir($log_dir, 0755);
}

//Datafile get
$data_dir = rtrim($data_dir, '/') . "/get-item-withtemplate";
...
$temp_dir = rtrim($output_dir, '/') . "/get-item-withtemplate_{$date}_{$time}";
...
foreach ($export_array as $key => $value) {
	...
	$output_file = $temp_dir . "/" . "get-item-withtemplate_{$output_host}_{$date}_{$time}.json";
...
if (isset($output_array[0])) {
	$z_file = "{$output_dir}/get-item-withtemplate_{$date}_{$time}.zip";
